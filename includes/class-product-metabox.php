...
class CWPC_Product_Metabox {
	...
	public function panel() {
		...
		echo '<h4>Section 4-5 — Chair Variants and Colors Per Variant</h4><p class="description">Each chair variant has its thumbnail, white/base image, position, price, and its own available color list.</p><div id="cwpc-chair-designs" class="cwpc-repeat-list"></div><p><button type="button" class="button cwpc-add-row" data-target="chair_designs">Add Chair Variant</button></p>';
