...
class CWPC_Product_Metabox {
	...
	public function panel() {
		...
		echo '<h4>Preview Recolor Layers</h4><p class="description">Set the popup label, upload base images, and upload transparent PNG masks. Colors are applied dynamically from color codes.</p><div id="cwpc-dining-preview-assets" class="cwpc-repeat-list"></div>';
