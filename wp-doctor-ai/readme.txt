...
Tags: diagnostics, page speed, core web vitals, javascript, troubleshooting
...
WordPress diagnostics and issue explanation platform for Core Web Vitals, page speed bottlenecks, console errors, AJAX failures, jQuery conflicts, duplicate scripts, and Elementor crashes.

== Description ==

WP Doctor AI is a WordPress diagnostics and issue explanation platform. It helps site owners, developers, agencies, WooCommerce store owners, and Elementor users understand page speed and front-end issues without reading cryptic browser errors. In this plugin, an explanation means a human-readable summary of a detected issue: what happened, why it matters, likely impact, and safe next steps. In Pro with a Google AI Studio key, explanations are generated by Gemini from the deterministic issue data; without AI they use offline fallback text.
...
The MVP can detect page speed, JavaScript, and AJAX problems that may affect WooCommerce pages, such as slow product pages, checkout button failures, or failed background requests. Dedicated WooCommerce diagnostics are planned as a future module.
...
1. Dashboard overview with total issues, critical issues, AJAX failures, page speed issues, and recent scans.
